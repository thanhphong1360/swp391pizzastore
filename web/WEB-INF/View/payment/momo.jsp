...
<html lang="vi">
    <head>
        ...
        <title>Thanh toán MoMo | Pizza House</title>
    ...
    <body>
                ...
                <div class="col-md-6">
                    <div class="payment-card">
                        ...
                        <div class="qr-container">
                            <img src="${pageContext.request.contextPath}/assets/images/momo-qr.png" 
                                 alt="MoMo QR" class="img-fluid">
                        </div>
                        ...
                        <div class="alert alert-light alert-custom">
                            ...
                            STK: <strong>0123456789</strong> - Vietcombank<br>
        ...
        <script>
            // TỰ ĐỘNG THÀNH CÔNG SAU 10 GIÂY (GIẢ LẬP)
            setTimeout(() => {
